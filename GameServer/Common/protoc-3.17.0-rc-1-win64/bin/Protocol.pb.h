...
inline ::PROTOBUF_NAMESPACE_ID::uint64 S_DESPAWN::_internal_object_ids(int index) const {
  return object_ids_.Get(index);
}
inline ::PROTOBUF_NAMESPACE_ID::uint64 S_DESPAWN::object_ids(int index) const {
  // @@protoc_insertion_point(field_get:Protocol.S_DESPAWN.object_ids)
  return _internal_object_ids(index);
}
inline void S_DESPAWN::set_object_ids(int index, ::PROTOBUF_NAMESPACE_ID::uint64 value) {
  object_ids_.Set(index, value);
  // @@protoc_insertion_point(field_set:Protocol.S_DESPAWN.object_ids)
}
inline void S_DESPAWN::_internal_add_object_ids(::PROTOBUF_NAMESPACE_ID::uint64 value) {
  object_ids_.Add(value);
}
inline void S_DESPAWN::add_object_ids(::PROTOBUF_NAMESPACE_ID::uint64 value) {
